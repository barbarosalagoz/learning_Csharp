...
namespace Personel_Kayıt
{
    public partial class FrmAnaForm : Form
    {
        ...
        {
            baglanti.Open();
            SqlCommand komutguncelle = new SqlCommand("Update Tbl_Personel Set PerAd=@a1, PerSoyad=@a2, PerSehir=@3, PerMaas= @4, PerDurum=@5, PerMeslek=@6 where PerId=@a7", baglanti);
